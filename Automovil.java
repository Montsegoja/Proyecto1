...
public class Automovil {
    ...
    public Automovil(String modelo, String color, String anio, String marca, String chasis, String propietario, int vel_lmax, int vel_act, int num_p, String techo_solar, int num_marcha, String trans_aut, double vol_comb, String nombre, String curp, String rfc) {
        this.modelo = modelo;
        this.color = color;
        this.anio = anio;
        this.marca = marca;
